...
<Typography variant="h4" gutterBottom id="ustory" style={{textAlign:"center",color:"#ffff"}}>
  <span style={{borderBottom:"3px solid #7dc5ff"}}>- Abstract peek into me -</span>
      </Typography>
</Grid>
...
<Grid  item xs={12} sm={12} lg={6} md={6} id="wordle1" gutterBottom>
  ...
  <svg
      ...
      style={{width:"81%",top:"0",left:"0",height:"81%"}} 
      id="wordlesvg1">
      <text
        y={-1020.056}
        x={374.235}
...
<Fade left>
  ...
  <Box pt={10} pl={4} pr={4} clone order={{ xs: 4, sm: 4,md:4, lg: 4}}>
